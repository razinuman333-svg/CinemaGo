...
function MovieDetails() {
  ...
  <div className='  px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
    <div className='  flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
      <img className='max-md:mx-auto rounded-xl h-104 max-w-70 object-cover' src={show.movie.poster_path}/>
    ...
    <div className='overflow-x-auto no-scrollbar mt-8 pb-4 '>
      <div className='flex items-center gap-4 w-max px-4'>
        {show.movie.casts.slice(0,10).map((cast,index)=>(
          ...
          <img className='rounded-full h-20 md:h-20 aspect-square object-cover' src={cast.poster_path}/>
